  ...
  if(isset($_GET['mode']) == 'request'){
    ...
    $queryImg = $connect->query($sqlImg);
      ...
      $folder = "./image/" . $filename;
			...
			$sqlCont = "INSERT INTO tbl_posts(uid,user,postTime,content,pfp,filename) VALUES ('$userNum','$currentUser','$date','$content','$profilePic','$filename')";
                  ...
                  <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ml-2">
                          <p>
                            <a href="user.php?id=<?= $post['uid']; ?>" class="text-dark"><?php echo $post['user']; ?></a>
                          </p>
                  ...
                  <div class="card-body" id="card-suggestions">
                    ...
                    <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                      ...
                      <button class="btn btn-icon">
                        <a href="home.php?mode='request'&rid=<?= $users['id']; ?>&rname=<?= $users['username']; ?>&rpfp=<?= $users['filename']; ?>" class="text-dark">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                          fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
